...
output_dir=$bids_dir/derivatives/adak_${task_id}_2mm			# analysis output directory for fmriprep 3mm data
...
tr=2
fwhm=6
output_space=MNI152NLin6Asym_res-02	# MNI152NLin6Asym_res-07	#MNI152NLin6Asym3mm_res-01 # MNI152NLin6Asym_res-2
